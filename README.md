...
<h1>Deploying Active Directory in Azure (Virtual Machine)</h1>
After Installed Active Directory Infrastructure in Azure, we are ready to start deploying Active Directory in our Virtual Machine.<br />
